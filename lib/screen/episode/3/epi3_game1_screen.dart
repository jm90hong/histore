...
class Epi3Game1Screen extends StatefulWidget {
  @override
  _Epi3Game1ScreenState createState() => _Epi3Game1ScreenState();
}

class _Epi3Game1ScreenState extends State<Epi3Game1Screen> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: BackgroundContainer(
            imagePath: 'assets/image/episode3/bg6.png',
            child: Stack(
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset('assets/image/episode3/c1.png',height: 400,),
                        Image.asset('assets/image/episode3/c9.png',height: 400,),
                      ],
                    ),
                  ),
                ),
